...
conn = psycopg2.connect(host='localhost', user='postgres', password="mugilven", port=5432, database="Bizcard")
cursor = conn.cursor()
...
if selected == 'Home':
    ...
    st.markdown(
        "### :red[Technologies used :]  Python, easyOCR, PostgreSQL, pandas, Streamlit.")
    st.markdown(
